...
endy.fonts = {
	ffBuild: function () {
		var n = [{name: "Decima", url: "../fonts/dnp.woff2", options: {weight: "normal"}}, {
			name: "Decima",
			url: "../fonts/dnpbold.woff2",
			options: {weight: "bold"}
		}], e = [];
		...
		"function" == typeof FontFace ? endy.fonts.ffBuild() : document.addEventListener("DOMContentLoaded", function () {
			...
			n.setAttribute("href", "../css/fonts.css"), n.setAttribute("rel", "stylesheet"), document.querySelector("body").appendChild(n), endy.fonts.readyActions()
		})
	}
}, endy.fonts.init();